 ...
 *
 * @param <T1>
 *            The type of the first non-null value held by this tuple
 * @param <T2>
 *            The type of the second non-null value held by this tuple
 * @author Jon Brisbin
...
public class Tuple2<T1, T2> implements Iterable<Object>, Serializable {
	 ...
	 *
	 * @param index
	 *            The index of the object to retrieve. Starts at 0.
